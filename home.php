...
<body>
    <div class="header">
        ...
        <div class="middle">
            <form id="searchForm" action="FilteredBooks.php" method="get">
                <img class="find" src="img/icons8-search-48.png" width="18" height="18">
                <input class="enterSpace" type="text" id="searchInput" name="search"
        ...
        <div class="main_board">
            <div class="white_container">
                <div class="genre">
                    ...
                    <div class="genre_end">
                        <div class="book">
                            <img class="book_cover" src="img\81nq+ewtkcL._AC_UF1000,1000_QL80_.jpg" width="120px"
                                height="160px">
